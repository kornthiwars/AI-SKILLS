...
Inventory for `ai-skills/debug/`. Update when adding or removing files.
...
| [assets/template.diagnosis-report.md](assets/template.diagnosis-report.md) | Gate D report | Before fix |
| [assets/template.post-fix-learning.md](assets/template.post-fix-learning.md) | Optional vault learning draft | After fix + user wants note |
