...
Daily **work** log — one file per day.

## File pattern

```
YYYY-MM-DD.md    ← e.g. 2026-05-24.md
```
...
This README is tracked. `*.md` notes here are **local only** (gitignored).

Agent creates this folder before first write if missing.
